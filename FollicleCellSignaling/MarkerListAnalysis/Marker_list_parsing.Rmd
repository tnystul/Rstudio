...
for(x in 1:nrow(markers)) {
    ...
    # DoHeatmap(geno_av, features = markers.list[x], draw.lines = F, raster = T)  
    # ggsave(paste("MarkerListPlots/", cell_genotype, x, "_Heatmap", ".pdf", sep = ""), width = 7, height = 10)
    # FeaturePlot(Rust, features = markers.list[x])
